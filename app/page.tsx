...
<section className="bg-white py-20 px-6">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
    ...
    <div className="bg-[#1e293b] p-10 rounded-[1rem] shadow-xl border-2 border-white/5 hover:-translate-y-2 transition-all flex flex-col justify-between min-h-[350px]">
      <div>
